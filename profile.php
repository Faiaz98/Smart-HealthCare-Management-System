			...
			<div class="card">
				...
				<div class="card-body">
					<form method="post" id="edit_profile_form">
						...
						<div class="form-group">
							<label>Patient Medical History<span class="text-danger">*</span></label>
							<textarea name="patient_medical_history" id="patient_medical_history" class="form-control" required data-parsley-trigger="keyup"></textarea>
						</div>
				...
				<div class="card-body">
					<table class="table table-striped">
						...
						<tr>
							...
							<td><?php echo $row["patient_medical_history"]; ?></td>
						</tr>
						<?php
						}
						?>	
...
$('#patient_medical_history').val("<?php echo $row['patient_medical_history']; ?>");
