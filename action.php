	...
	if($_POST['action'] == 'patient_register')
	{
		...
		else
		{
			...
			$data = array(
				...
				':patient_medical_history'      =>  $object->clean_input($_POST["patient_medical_history"]),
			...
			(patient_email_address, patient_password, patient_first_name, patient_last_name, patient_date_of_birth, patient_gender, patient_address, patient_phone_no, patient_maritial_status, patient_medical_history, patient_added_on, patient_verification_code, email_verify) 
			VALUES (:patient_email_address, :patient_password, :patient_first_name, :patient_last_name, :patient_date_of_birth, :patient_gender, :patient_address, :patient_phone_no, :patient_maritial_status, :patient_medical_history, :patient_added_on, :patient_verification_code, :email_verify)
			";
